...
from src.python_coder.prompts.loader import _read_prompt_template_file, default_prompt, _get_prompt_template, get_prompt
...
class TestPrompts:
    ...
    def test_read_prompt_template_file_not_found(self):
        ...
        with patch("builtins.open", side_effect=FileNotFoundError):
            ...
            with patch("src.python_coder.prompts.loader._get_prompt_template", return_value=default_prompt):
